...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_Dimmung_01_Timeout.py
# Title   : CAN_EI_Rx_Signals_Dimmung_01_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message Dimmung_01
...
try:
    ...
    period_var = hil.Dimmung_01__period
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_186")
