...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_OBD_03_Timeout.py
# Title   : CAN_EI_Rx_Signals_OBD_03_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message OBD_03
...
try:
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_193")
