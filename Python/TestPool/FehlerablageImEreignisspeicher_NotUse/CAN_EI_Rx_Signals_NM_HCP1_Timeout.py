...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_NM_HCP1_Timeout.py
# Title   : CAN_EI_Rx_Signals_NM_HCP1_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message NM_HCP1
...
# 1.1  | 27.07.2021  | Mohammed   | Rework
...
try:
    ...
    period_var = hil.NM_HCP1__period
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_191")
    ...
    testresult.append(canape_diag.checkEventMemory([(0x800001, 0x27)], ticket_id='FehlerId:33'))
