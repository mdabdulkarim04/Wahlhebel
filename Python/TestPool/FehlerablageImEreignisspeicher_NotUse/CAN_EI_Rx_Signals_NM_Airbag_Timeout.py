...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_NM_Airbag_Timeout.py
# Title   : CAN_EI_Rx_Signals_NM_Airbag_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message NM_Airbag
...
try:
    ...
    period_var = hil.NM_Airbag__period
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_190")
