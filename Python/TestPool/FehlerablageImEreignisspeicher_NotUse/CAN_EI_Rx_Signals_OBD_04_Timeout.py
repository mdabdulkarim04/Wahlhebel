...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_OBD_04_Timeout.py
# Title   : CAN_EI_Rx_Signals_OBD_04_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message OBD_04
...
try:
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_189")
    testresult.setTestcaseId("TestSpec_189")
