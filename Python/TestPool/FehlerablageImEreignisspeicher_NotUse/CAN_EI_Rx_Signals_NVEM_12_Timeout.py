...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_NVEM_12_Timeout.py
# Title   : CAN_EI_Rx_Signals_NVEM_12_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message NVEM_12
...
try:
    ...
    period_var = hil.NVEM_12__period
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_192")
