...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_ORU_Control_A_01_Timeout.py
# Title   : CAN_EI_Rx_Signals_ORU_Control_A_01_Timeout
...
try:
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_194")
    ...
    active_dtcs = [(0xE0000E, 0x2F)]
    testresult.append(canape_diag.checkEventMemory(active_dtcs, ticket_id='FehlerId:33'))
    ...
    passive_dtcs = [(0xE0000E, 0x2C)]
    testresult.append(canape_diag.checkEventMemory(passive_dtcs, ticket_id='FehlerId:33'))
