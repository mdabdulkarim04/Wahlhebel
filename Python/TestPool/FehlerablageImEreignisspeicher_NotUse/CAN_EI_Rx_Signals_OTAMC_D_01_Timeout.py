...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_OTAMC_D_01_Timeout.py
# Title   : CAN_EI_Rx_Signals_OTAMC_D_01_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message OTAMC_D_01
...
try:
    ...
    # set Testcase ID #########################################################
    #setTestcaseId(testresult, "TestSpec_197")
