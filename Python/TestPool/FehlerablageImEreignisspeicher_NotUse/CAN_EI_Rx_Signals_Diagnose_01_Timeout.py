...
# -*- coding: latin-1 -*-
#
# File    : CAN_EI_Rx_Signals_Diagnose_01_Timeout.py
# Title   : CAN_EI_Rx_Signals_Diagnose_01_Timeout
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message Diagnose_01
...
try:
    ...
    period_var = hil.Diagnose_01__period
    ...
    exp_dtc = 0x003039  # TODO

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_187")
    #setTestcaseId(testresult, "TestSpec_187")
