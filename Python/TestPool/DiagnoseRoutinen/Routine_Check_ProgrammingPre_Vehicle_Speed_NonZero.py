# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Vehicle_Speed_NonZero.py
# Title   : Routine Check ProgrammingPre Vehicle Speed NonZero
...
# 1.2  | 17.11.2021 | Mohammed     | Rework after Isyst Review
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_257")
