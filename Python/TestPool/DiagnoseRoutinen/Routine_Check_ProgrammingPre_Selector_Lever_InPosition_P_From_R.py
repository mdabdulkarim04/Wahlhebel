# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Selector_Lever_InPosition_P_From_R.py
# Title   : Routine Check ProgrammingPre SelectorLever InPosition P From R
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_260")
    ...
    # test step 12
    testresult.append(["[.] Setze SiShift_01:SIShift_StLghtDrvPosn = R", ""])
