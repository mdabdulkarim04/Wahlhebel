# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Selector_Lever_InPosition_P_From_N.py
# Title   : Routine Check ProgrammingPre SelectorLever InPosition P From N
...
# 1.5  | 10.01.2022 | Mohammed     | Corrected exp_wrong_prec value
# 1.6  | 14.04.2022 | Mohammed     | Added Zykluszeit
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_263")
    ...
    # test step 12
    testresult.append(["[.] Setze SiShift_01:SIShift_StLghtDrvPosn auf N", ""])
    testresult.append(func_gs.changeDrivePosition('N'))
