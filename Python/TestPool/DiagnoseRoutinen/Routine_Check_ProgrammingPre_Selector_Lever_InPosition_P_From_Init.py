# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Selector_Lever_InPosition_P_From_Init.py
# Title   : Routine Check ProgrammingPre SelectorLever InPosition P From Init
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_265")
    ...
    # test step 12
    testresult.append(["[.] Setze SiShift_01:SIShift_StLghtDrvPosn = Init", ""])
    testresult.append(func_gs.changeDrivePosition('Init'))
