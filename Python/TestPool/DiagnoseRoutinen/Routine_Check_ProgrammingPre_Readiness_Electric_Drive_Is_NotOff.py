# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Readiness_Electric_Drive_Is_NotOff.py
# Title   : Routine Check ProgrammingPre Readiness Electric Drive Is NotOff
...
# 1.4  | 14.04.2022 | Mohammed     | Added Zykluszeit
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_261")
    ...
    # test step 12
    testresult.append(["[.] Setze OBD_04:MM_PropulsionSystemActive == 0x1 ", ""])
