# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Igni_Is_Switched_Off.py
# Title   : Routine Check ProgrammingPre Igni Is Switched Off
...
# 1.5  | 24.05.2022 | Mohammed     | Aktualisiert  Vorbedingungen
# *****************************************************************************
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_262")
    ...
    testresult.append(["[.] PropulsionSystemActive = NotAktiv (0)", ""])
    ...
    # test step 12
    testresult.append(["[.] Setze Klemme 15 auf aus", ""])
    hil.cl15_on__.set(0)
