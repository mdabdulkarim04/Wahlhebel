# *****************************************************************************
# -*- coding: latin-1 -*-
# File    : Routine_Check_ProgrammingPre_Selector_Lever_InPosition_P_From_D.py
# Title   : RPCplus Production SesionWechseln inISO Frequenz
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_264")
    ...
    # test step 12
    testresult.append(["[.] Setze SiShift_01:SIShift_StLghtDrvPosn = D", ""])
    testresult.append(func_gs.changeDrivePosition('D'))
