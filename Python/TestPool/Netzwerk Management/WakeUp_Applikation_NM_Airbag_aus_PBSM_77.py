...
try:
    ...
    testresult.append(["\x0a2. Prüfe Versenden (Timestamps/Zykluszeit) der gesendeten Applikations- und NM Botschaften:", ""])
    ...
    for var in meas_vars:
        if (var != hil.cl15_on__) and (var != hil.NM_Airbag__NM_Airbag_01_FCAB__value):
            ...
            # if wakeup_time:
            #     testresult.append(["\xa0Prüfe, dass Botschaft %s nach 'Senden der NM_Airbag Botschaft' werden gesendet " % str(var), ""])
            #     testresult.append(
    ...
    testresult.append(["\x0aPrüfe, dass NM-Botschaften vor der Applikationsbotschaft gesendet wird", ""])
