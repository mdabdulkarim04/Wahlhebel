# -*- coding: latin1 -*-
# File    : WakeUp_Applikation_NM_Airbag.py
# Title   : WakeUp Applikation NM_Airbag  erst mit gültigem FCAB
# Task    : WakeUp durch die Applikation (Empfang NM_Airbag Botschaft) erst mit gültigem FCAB
#
...
# ------------------------------------------------------------------------------
# 1.0  | 15.07.2021 | Mohammed Abdul Karim  | initial
# 1.1  | 09.11.2021 | Devangbhai   | Reworked
# 1.2  | 18.11.2021 | Devangbhai   | Added 130ms extra to check after sending the 10 NM airbag message
# 1.3  | 10.12.2021 | Devangbhai   | Reworked
# 1.4  | 21.12.2021 | Mohammed     | Added Fehler Id
# 1.5  | 08.03.2022 | Devangbhai   | Removed 20ms cycle time
# 1.6  | 28.03.2022 | Mohammed     | Added FCAB Fehler Id
# 1.7  | 27.07.2022 | Mohammed     | Added FCAB New Value
# ******************************************************************************
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_114")
    ...
    time.sleep(1)
    testresult.append(["\x0a2. NM_HCP1-Botschaft mit Signal NM_HCP1_01_CBV_CRI = 1 und NM_HCP1_01_FCAB = 13_Airbag 10x senden", ""])
    time_to_check = 1.9
    t_out = time_to_check + t()
    timestamp = []

    hil.NM_HCP1__NM_HCP1_FCAB__value.set(4096)
    ...
    testresult.append(basic_tests.checkStatus(hil.NM_Waehlhebel__NM_Waehlhebel_FCAB__value, 0, descr="NM_Waehlhebel_FCAB:Inaktiv"))
    #testresult.append(func_nm.checkFcabBitwise(hil.NM_Waehlhebel__NM_Waehlhebel_FCAB__value.get(), [12], [], descr="NM_Waehlhebel_FCAB:12_GearSelector",ticket_id='Fehler-Id: EGA-PRM-19'))
    ...
    testresult.append(basic_tests.checkStatus(hil.NM_Waehlhebel__NM_Waehlhebel_NM_State__value, 1, descr="NM_Waehlhebel_NM_State:NM_RM_aus_BSM"))
    ...
    testresult.append(basic_tests.checkStatus(hil.NM_Waehlhebel__NM_Waehlhebel_NM_aktiv_KL15__value, 0, descr="NM_Waehlhebel_NM_aktiv_KL15:Inaktiv"))
    ...
    testresult.append(basic_tests.checkStatus(hil.NM_Waehlhebel__NM_Waehlhebel_NM_aktiv_Tmin__value, 1, descr="NM_Waehlhebel_NM_aktiv_Tmin:Mindestaktivzeit"))
    ...
    testresult.append(_checkStatus(current_status=hil.NM_Waehlhebel__NM_Waehlhebel_UDS_CC__value, nominal_status=0,
                                   descr="Prüfe NM_Waehlhebel:NM_Waehlhebel_UDS_CC = 0 (inaktiv) ist",ticket_id='FehlerId:EGA-PRM-19'))
    ...
    time.sleep(0.75)
    #testresult.append(["Prüfe, dass nach Busruhe ist", "INFO"])
    #busruhe_after = basic_tests.checkRange(value=hil.cc_mon__A.get(), min_value=0.0, max_value=0.002,
    #                                       descr="Prüfe, dass Strom zwischen 0mA und 2mA liegt")
    ...
    testresult.append(daq.plotMultiShot(nm_data, "NM_Waehlhebel__timestamp_114"))
    ...
    t_hcp1_sent = hcp1_mess.findNext("==", 4096)
