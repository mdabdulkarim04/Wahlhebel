#******************************************************************************
# -*- coding: latin1 -*-
# File    : WakeUp_Applikation_NM_Airbag_aus_BSM_74.py
# Task    : A minimal "WakeUp_Applikation_NM_Airbag_aus_BSM!" test script
#
...
#******************************************************************************
## Test-Case
##Wake Up verursacht durch die Applikation (Empfang NM_Airbag Botschaft) aus BSM
import time
...
try:
    ...
    time.sleep(.100)
 ## Set Testcas ID
    testresult.setTestcaseId("TestSpec_74")
## 1. NM_Airbag-Botschaft mit FCAB = 13_Airbag  5x senden, CAN-Traceverlauf auswerten und 4000 ms warten
    ...
    hil.NM_Airbag__NM_Airbag_01_FCAB__value.set(1)
##### Zykluszeit der Botschaft NM_Waehlhebel entspricht für erste 10 Botschaften 20 ms,

    ### Zykluszeit der Botschaft NM_Waehlhebel entspricht für erste 10 Botschaften 20 m
    testresult.append(["1. NM_Airbag-Botschaft mit FCAB = 13_Airbag  5x senden, CAN-Traceverlauf auswerten","Aktion"])
    ...
    testresult += [
        ...
        basic_tests.checkStatus(hil.NM_Waehlhebel__NM_Waehlhebel_NM_aktiv_Diag__value, 0, descr="NM_Waehlhebel_NM_aktiv_Diag:Inaktiv"),
    ...
    time.sleep(1.0)
    testresult += [basic_tests.checkTolerance(hil.Waehlhebel_04__Waehlhebel_04_BZ__value, 15,0.1, descr="Waehlhebel_04_BZ")]
 ...
 #####
    time.sleep(10.0)
    testresult += [basic_tests.checkTolerance(hil.Waehlhebel_04__Waehlhebel_04_BZ__value, 6, 1,descr="Waehlhebel_04_BZ:Busruhe")]
## Cleanup
    hil=None
