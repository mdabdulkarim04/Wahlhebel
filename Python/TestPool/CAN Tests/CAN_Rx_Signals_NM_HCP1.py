...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_NM_HCP1.py
# Title   : CAN Rx Signals NM HCP1
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message NM_HCP1
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'NM_HCP1__NM_HCP1_FCAB')
    testresult.append(["\nMessage/PDU: NM_HCP1:NM_HCP1_FCAB", ""]) 

    # #########################################################################
    # NM_HCP1:NM_HCP1_FCAB
    #
    ...
    testresult.append(testRxSigSeq(
        set_sig      = can_bus.NM_HCP1__NM_HCP1_FCAB__value,
        check_var    = cal.NM_HCP1__NM_HCP1_FCAB, # TODO: Add correct cal-variable from .a2l
