...
try:
    ...
    for timer_values in timerlist:
        if value != timer_values:
            ...
            break
    testresult.append(
        ["\xa0 Prüfe KN_Waehlhebel_DiagPfad_V12 hat %s Sekunde konstant %s gebleiben" % (sec, value),
         "PASSED"]) if value_boolean else testresult.append(
        ["\xa0 KN_Waehlhebel_DiagPfad_V12 nicht konstant gebleiben", "FAILED"])

    testresult.append(["[.] Prüfe KN_Waehlhebel:KN_Waehlhebel_DiagPfad_V12 = 0x0 gesendet", ""])
    testresult.append(
