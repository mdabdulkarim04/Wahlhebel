...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_XCP_Waehlhebel_CRO_01.py
# Title   : CAN Rx Signals XCP Waehlhebel CRO 01
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message XCP_Waehlhebel_CRO_01
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'XCP_Waehlhebel_CRO_01__XCP_Waehlhebel_CRO_01_Data')
    testresult.append(["\nMessage/PDU: XCP_Waehlhebel_CRO_01:XCP_Waehlhebel_CRO_01_Data", ""]) 

    # #########################################################################
    # XCP_Waehlhebel_CRO_01:XCP_Waehlhebel_CRO_01_Data
    #
    ...
    testresult.append(testRxSigSeq(
        set_sig      = can_bus.XCP_Waehlhebel_CRO_01__XCP_Waehlhebel_CRO_01_Data__value,
        check_var    = cal.XCP_Waehlhebel_CRO_01__XCP_Waehlhebel_CRO_01_Data, # TODO: Add correct cal-variable from .a2l
