...
# -*- coding: latin-1 -*-
#
# File    : CAN_Tx_Signals_DIA_SAAM_Resp.py
# Title   : CAN Tx Signals DIA SAAM Resp
# Task    : Test of ECU-Tx => HIL-Rx Signals of CAN Message DIA_SAAM_Resp
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'DIA_SAAM_Resp__DIA_SAAM_Resp_Data')
    testresult.append(["\nMessage/PDU: DIA_SAAM_Resp:DIA_SAAM_Resp_Data", ""]) 

    # #########################################################################
    # DIA_SAAM_Resp:DIA_SAAM_Resp_Data
    #
    ...
    testresult.append(testTxSigSeq(
        set_var      = cal.DIA_SAAM_Resp__DIA_SAAM_Resp_Data, # TODO: Add correct cal-variable from .a2l
        check_sig    = can_bus.DIA_SAAM_Resp__DIA_SAAM_Resp_Data__value,
