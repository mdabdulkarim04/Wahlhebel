...
# -*- coding: latin-1 -*-
#
# File    : CAN_RX_Signal_ORU_Control_A_01_ORU_Control_A_01_BZ.py
# Title   : CAN Rx Signals ORU Control A 01 BZ
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message ORU_Control_A_01_BZ
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("CAN_112")
