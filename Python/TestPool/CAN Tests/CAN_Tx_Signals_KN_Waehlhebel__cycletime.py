...
# -*- coding: latin-1 -*-
#
# File    : CAN_Tx_Signals_KN_Waehlhebel__cycletime.py
# Title   : CAN Tx Signals KN Waehlhebel cycletime
...
try:
    ...
    testresult.setTestcaseId("CAN_73")
    ...
    # TEST PROCESS ############################################################
    testresult.append(['Check the cycle time of the message KN_Waehlhebel.','INFO'])
    testresult.append(
        simplified_bus_tests.checkTiming(
            time_stamp_variable=hil.KN_Waehlhebel__timestamp, 
            cycle_time_value_ms=cycle_time_ms,
            message_name="KN_Waehlhebel",
