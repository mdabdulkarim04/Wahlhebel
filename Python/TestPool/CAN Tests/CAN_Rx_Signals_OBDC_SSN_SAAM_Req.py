...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_OBDC_SSN_SAAM_Req.py
# Title   : CAN Rx Signals OBDC SSN SAAM Req
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message OBDC_SSN_SAAM_Req
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'OBDC_SSN_SAAM_Req__OBDC_SSN_SAAM_Req_Data')
    testresult.append(["\nMessage/PDU: OBDC_SSN_SAAM_Req:OBDC_SSN_SAAM_Req_Data", ""]) 

    # #########################################################################
    # OBDC_SSN_SAAM_Req:OBDC_SSN_SAAM_Req_Data
    #
    ...
    testresult.append(testRxSigSeq(
        set_sig      = can_bus.OBDC_SSN_SAAM_Req__OBDC_SSN_SAAM_Req_Data__value,
        check_var    = cal.OBDC_SSN_SAAM_Req__OBDC_SSN_SAAM_Req_Data, # TODO: Add correct cal-variable from .a2l
