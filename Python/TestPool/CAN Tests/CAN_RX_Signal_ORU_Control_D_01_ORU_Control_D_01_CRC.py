...
# -*- coding: latin-1 -*-
#
# File    : CAN_RX_Signal_ORU_Control_D_01_ORU_Control_D_01_CRC.py
# Title   : CAN Rx Signals ORU Control D 01 CRC
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message ORU_Control_D_01_CRC
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("CAN_116")
    ...
    ORU_Control_D_CRC = hil.ORU_Control_D_01__ORU_Control_D_01_CRC__value
    meas_vars = [ORU_Control_D_CRC]
