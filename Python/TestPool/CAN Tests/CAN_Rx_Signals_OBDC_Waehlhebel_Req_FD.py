...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_OBDC_Waehlhebel_Req_FD.py
# Title   : CAN Rx Signals OBDC Waehlhebel Req FD
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message OBDC_Waehlhebel_Req_FD
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'OBDC_Waehlhebel_Req_FD__OBDC_Waehlhebel_Req_FD_Data')
    testresult.append(["\nMessage/PDU: OBDC_Waehlhebel_Req_FD:OBDC_Waehlhebel_Req_FD_Data", ""]) 

    # #########################################################################
    # OBDC_Waehlhebel_Req_FD:OBDC_Waehlhebel_Req_FD_Data
    #
    ...
    testresult.append(testRxSigSeq(
        set_sig      = can_bus.OBDC_Waehlhebel_Req_FD__OBDC_Waehlhebel_Req_FD_Data__value,
        check_var    = cal.OBDC_Waehlhebel_Req_FD__OBDC_Waehlhebel_Req_FD_Data, # TODO: Add correct cal-variable from .a2l
