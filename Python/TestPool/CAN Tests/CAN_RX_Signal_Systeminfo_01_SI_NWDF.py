...
# -*- coding: latin-1 -*-
#
# File    : CAN_RX_Signal_Systeminfo_01_SI_NWDF.py
# Title   : CAN Rx Signals Systeminfo_01_NWDF
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message Systeminfo_01_SI_NWDF
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("CAN_313")
    ...
    testresult.append(testRxSigSeq(
        set_sig=can_bus.Systeminfo_01__SI_NWDF__value,
        check_var=cal.Swc_GSL_Diag_Swc_GSL_Diag_Run_SI_NWDF_SI_NWDF,
        set_values=[0x0, 0x1],
