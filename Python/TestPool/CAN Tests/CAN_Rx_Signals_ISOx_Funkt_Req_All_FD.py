...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_ISOx_Funkt_Req_All_FD.py
# Title   : CAN Rx Signals ISOx Funkt Req All FD
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message ISOx_Funkt_Req_All_FD
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'ISOx_Funkt_Req_All_FD__ISOx_Funkt_Req_All_FD_Data')
    testresult.append(["\nMessage/PDU: ISOx_Funkt_Req_All_FD:ISOx_Funkt_Req_All_FD_Data", ""]) 

    # #########################################################################
    # ISOx_Funkt_Req_All_FD:ISOx_Funkt_Req_All_FD_Data
    #
    ...
    testresult.append(testRxSigSeq(
        set_sig      = can_bus.ISOx_Funkt_Req_All_FD__ISOx_Funkt_Req_All_FD_Data__value,
        check_var    = cal.ISOx_Funkt_Req_All_FD__ISOx_Funkt_Req_All_FD_Data, # TODO: Add correct cal-variable from .a2l
