...
# -*- coding: latin-1 -*-
#
# File    : CAN_Rx_Signals_ISOx_Waehlhebel_Req_FD.py
# Title   : CAN RX Signals ISOx_Waehlhebel_Req_FD cycletime
# Task    : Test Cycletime of ECU-Tx => HIL-Rx Signals of CAN Message ISOx_Waehlhebel_Req_FD
#
...
try:
    ...
    testresult.setTestcaseId("CAN_55")
    ...
    testresult.append(["\x0a Check the cycle time of the message ISOx_Waehlhebel_Req_FD:Zykluszeit von 2s + +/-10ms gesendet ", "INFO"])
    testresult.append(
        simplified_bus_tests.checkTiming(
            time_stamp_variable=hil.ISOx_Waehlhebel_Req_FD__timestamp,
            cycle_time_value_ms=cycle_time_ms,
            message_name="ISOx_Waehlhebel_Req_FD",
            tol_perc=tolerance_percent,
            operator="==")
    )

    testresult.append(["[.] Tester Present deaktivieren", ""])
    testresult.append(["\x0a Check the cycle time of the message ISOx_Waehlhebel_Req_FD:nicht mehr gesendet", "INFO"])
