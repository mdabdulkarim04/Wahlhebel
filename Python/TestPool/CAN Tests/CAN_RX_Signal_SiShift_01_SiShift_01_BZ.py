...
# -*- coding: latin-1 -*-
#
# File    : CAN_RX_Signal_SiShift_01_SiShift_01_BZ.py
# Title   : CAN Rx Signals SiShift 01 BZ
# Task    : Test of HIL-Tx => ECU-Rx Signals of CAN Message SiShift_01_BZ
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("CAN_126")
    ...
    SiShift_01_BZ = hil.SiShift_01__SiShift_01_20ms_BZ__value
    meas_vars = [SiShift_01_BZ]
    ...
    testresult.append(testRxSigSeq(
        ...
        check_var=cal.Swc_GSL_GearDetection_PIM_SG_SiShift_01_SiShift_01_BZ,
    ...
    testresult.append(["[.] Setze values in CAN-Bus: [0x00, 0x8, 0xF]", ""])
    plot_data = {}
