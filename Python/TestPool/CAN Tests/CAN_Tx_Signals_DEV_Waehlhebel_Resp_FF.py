...
# -*- coding: latin-1 -*-
#
# File    : CAN_Tx_Signals_DEV_Waehlhebel_Resp_FF.py
# Title   : CAN Tx Signals DEV Waehlhebel Resp FF
# Task    : Test of ECU-Tx => HIL-Rx Signals of CAN Message DEV_Waehlhebel_Resp_FF
#
# Author  : A. Neumann
# Date    : 07.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'DEV_Waehlhebel_Resp_FF__DEV_Waehlhebel_Resp_FF_Data')
    testresult.append(["\nMessage/PDU: DEV_Waehlhebel_Resp_FF:DEV_Waehlhebel_Resp_FF_Data", ""]) 

    # #########################################################################
    # DEV_Waehlhebel_Resp_FF:DEV_Waehlhebel_Resp_FF_Data
    #
    ...
    testresult.append(testTxSigSeq(
        set_var      = cal.DEV_Waehlhebel_Resp_FF__DEV_Waehlhebel_Resp_FF_Data, # TODO: Add correct cal-variable from .a2l
        check_sig    = can_bus.DEV_Waehlhebel_Resp_FF__DEV_Waehlhebel_Resp_FF_Data__value,
