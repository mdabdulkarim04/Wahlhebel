...
# -*- coding: latin-1 -*-
#
# File    : Timeout_ORU_Control_A_01_Confirmation.py
# Title   : Timeout_ORU_Control_A_01_Confirmation
# Task    : Timeout_ORU_Control_A Fehlererkennung für Confirmed DTC im Fehlerspeicher
#
...
#------------------------------------------------------------------------------
# 1.0  | 21.07.2022  | Mohammed | initial
# 1.1  | 27.07.2022  | Mohammed  | Added waiting time during ECU_Sleep
#******************************************************************************
...
try:
    ...
    passiv_dtc = [(0xE00107, 0x24)]
    confirme_dtcs = [(0xE00107, 0x2F)]
    curr_value = func_nm.low_current()

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_401")
    ...
    # test step 5
    testresult.append(["[.] Warte 4500 ms (tMSG_Timeout: n-q+1, n=10, q=2) + 400ms (Tollerenz)", ""])
    time.sleep(4.9)
