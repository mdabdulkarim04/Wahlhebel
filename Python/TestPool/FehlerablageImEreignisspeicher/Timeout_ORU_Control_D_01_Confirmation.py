...
# -*- coding: latin-1 -*-
#
# File    : Timeout_ORU_Control_D_01_Confirmation.py
# Title   : Timeout_ORU_Control_D_01_Confirmation
# Task    : Timeout_ORU_Control_D Fehlererkennung für Confirmed DTC im Fehlerspeicher
#
...
try:
    ...
    passiv_dtc = [(0xE00108, 0x24)]
    confirme_dtcs = [(0xE00108, 0x2F)]
    curr_value = func_nm.low_current()

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_403")
    ...
    # test step 4
    testresult.append(["[.] Setze Zykluszeit der Botschaft ORU_Control_D_01 auf 0ms (ungültig)", ""])
