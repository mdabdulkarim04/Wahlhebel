...
# Task    : Fehlererkennung BZ-Fehler OTAMC_D_01 für Confirmed DTC im Fehlerspeicher
...
try:
    ...
    wait_time = 1500
    activ_dtc = [(0xE0010C, 0x27)]
    confirme_dtc = [(0xE0010C, 0x2F)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_418")
