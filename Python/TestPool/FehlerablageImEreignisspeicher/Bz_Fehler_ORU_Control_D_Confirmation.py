...
# -*- coding: latin-1 -*-
#
# File    : Bz_Fehler_OTAMC_D_01_Confirmation.py
# Title   : Bz_Fehler_OTAMC_D_01_Confirmation
# Task    : Fehlererkennung BZ-Fehler ORU_Control_D_01 für Confirmed DTC im Fehlerspeicher
...
# 1.1  | 04.08.2022 | Mohammed | Added TestID
#******************************************************************************
...
try:
    ...
    wait_time = 1500
    activ_dtc = [(0xE0010B, 0x27)]
    confirme_dtc = [(0xE0010B, 0x2F)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_417")
    ...
    testresult.append(["[.] Setze ORU_Control_D_01::ORU_Control_D_01_BZ fort (Setze Inkrementierung des Botschaftszählers wieder fort)", ""])
