#******************************************************************************
# -*- coding: latin1 -*-
# File    : Gangwechsel_R_nach_B1_B2_B1.py
# Title   : Gangwechsel R nach B1 B2 B1
# Task    : Gangwechsel aus R nach B2 über B1 (hin und zurück)
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_51")
