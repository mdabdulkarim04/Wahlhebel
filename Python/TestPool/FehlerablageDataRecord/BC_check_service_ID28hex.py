...
# -*- coding: latin-1 -*-
#
# File    : BC_check_service_ID28hex.py
# Title   : BC check_service for ID28hex
# Task    : BC check_service for ID28hex
#
# Author  : M.A. Mushtaq
# Date    : 23.02.2022
...
try:
    ...
    request = [[0x28, 0x01, 0x01], [0x28, 0x00, 0x01]]
    geschwindigkeit = [0, 0]
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_375")
    ...
    for i in range(2):
        ...
        if i == 0:
            ...
            testresult.append(canape_diag.checkNegativeResponse(response, [0x28], 0x22))  # 0x7f2822
