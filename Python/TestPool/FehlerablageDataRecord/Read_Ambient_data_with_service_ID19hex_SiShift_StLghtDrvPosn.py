...
# -*- coding: latin-1 -*-
#
# File    : Read_Ambient_data_with_service_ID19hex_SiShift_StLghtDrvPosn.py
# Title   : Read_Ambient_data_with_service_ID19hex_SiShift_StLghtDrvPosn
# Task    : Read Ambient data of dtc with 1906 SiShift_StLghtDrvPosn
#
...
# ------------------------------------------------------------------------------
# 1.0  | 11.04.2022 | Mohammed     | initial
# ******************************************************************************
#
# Imports #####################################################################
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_377b")

    # TEST PRE CONDITIONS #####################################################
    request = [0x19, 0x06, 0xE0, 0x00, 0x13, 0x01]
