# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_8.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 8
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_8!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_353")
    ...
    # test step 7
    testresult.append(["[.] Setze Clamp_15: ClampControl_01.KST_KL_15 auf 1", ""])
