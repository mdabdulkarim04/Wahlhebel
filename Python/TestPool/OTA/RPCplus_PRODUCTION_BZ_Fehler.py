# ******************************************************************************
# -*- coding: latin-1 -*-
# File    : RPCplus_PRODUCTION_BZ_Fehler.py
# Title   : RPCplus_PRODUCTION_BZ_Fehler
# Task    : RPCplus PRODUCTION in BZ Fehler
#
...
# 1.2  | 08.05.2022 | Mohammed  | Added Testschritte
# 1.3  | 24.05.2022 | Mohammed  | Aktualisiert  Vorbedingungen
# ******************************************************************************
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_290")
    ...
    testresult.append(["[+] Setze ORU_Control_D_01 auf BZ Error ", ""])
    ...
    testresult.append(["[.] Setze VDSO_Vx3d = 0 km/h", ""])
    ...
    # test step 6-6.10
    testresult.append(["[.] Setze gültige RPCplus PRODUCTION Vorbedingungen", ""])
