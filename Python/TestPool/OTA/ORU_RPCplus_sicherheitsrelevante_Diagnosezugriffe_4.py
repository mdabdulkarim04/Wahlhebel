# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_4.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 4
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_4!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_349")
    ...
    # test step 6
    testresult.append(["[.] Set Clamp_15 = ON: ClampControl_01.KST_KL_15 auf 1", ""])
