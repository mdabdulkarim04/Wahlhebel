# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_5.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 5
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_5!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_350")
    ...
    # test step 8
    testresult.append(["[.] System wartet 5100 ms.", ""])
    time.sleep(5.1)
