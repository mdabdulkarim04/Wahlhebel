# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_3.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 3
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_3!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_348")
    ...
    # test step 9
    testresult.append(["[.] Setze  ClampControl_01.KST_KL_15 auf 1 ", ""])
