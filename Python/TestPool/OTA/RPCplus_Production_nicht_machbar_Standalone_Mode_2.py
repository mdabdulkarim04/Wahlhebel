...
# -*- coding: latin-1 -*-
#
# File    : RPCplus_Production_nicht_machbar_Standalone_Mode_2.py
# Title   : RPCplus_Production_nicht_machbar_Standalone_Mode_2
# Task    : RPCplus Production nicht machbar in Standalone Mode 2
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_389")
