# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_6.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 6
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_6!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_351")
    ...
    # test step 9
    testresult.append(["[.] Setze VehicleProtectedEnvironment_D auf 2 (VPE_aftersales)", ""])
