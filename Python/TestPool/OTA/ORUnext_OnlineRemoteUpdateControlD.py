...
# -*- coding: latin-1 -*-
#
# File    : ORUnext_OnlineRemoteUpdateControlD.py
# Title   : ORUnext_OnlineRemoteUpdateControlD
# Task    : ORUnext OnlineRemoteUpdateControlD
#           
# Author  : MMohamed Abdul Karim
# Date    : 23.02.2022
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_305")
    ...
    testresult.append(["[.] Sezte ORU_CONTROL_D auf IDLE ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(0)
    testresult.append(["[.] Setze vbat_cl30__V auf 5.7 ", ""])
    hil.vbat_cl30__V.set(5.7)
    testresult.append(["[.] Setze ORU_Control_A_01 Signal aus ", ""])
    hil.ORU_Control_A_01__period.setState("aus")
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    ...
    # test step 12-12-2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf PENDING ", ""])
    ...
    # test step 16-16.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf PREPARATION ", ""])
    ...
    # test step 20-20.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf PREPARATION_HV ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(3)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
    ...
    # test step 24-24.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf RUNNING ", ""])
    ...
    # test step 28-28.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf RUNNING_HV ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(5)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
    ...
    # test step 32
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf PENDING_NOTREADY ", ""])
    ...
    # test step 36-36.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf OTA_FAILURE_POWERTRAIN_DISABLED ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(7)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
    ...
    # test step 40-40.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf FUNCTIONAL_SAFETY_RELEASE ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(8)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
    ...
    # test step 44-44.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf PREPARATION_SG ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(9)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
    ...
    # test step 48-48.2
    testresult.append(["[.] Setze ORU Signale ", ""])
    testresult.append(["[+] Sezte ORU_CONTROL_D auf Fehler ", ""])
    hil.ORU_Control_D_01__OnlineRemoteUpdateControlD__value.set(15)
    tMSG_CYCLE = 0.320  # sec
    testresult.append(["[.] Warte 320ms (tMSG_CYCLE) ", ""])
    time.sleep(tMSG_CYCLE)
    testresult.append(["[-0]", ""])
