...
# -*- coding: latin-1 -*-
#
# File    : RPCplus_AfterSales_nicht_machbar_Standalone_Mode_2.py
# Title   : RPCplus_AfterSales_nicht_machbar_Standalone_Mode_2
# Task    : RPCplus AfterSales nicht machbar in Standalone Mode 2
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_391")
    ...
    testresult.append(["[.] Setze kein E2E Timeout, CRC und BZ Error.", ""])
    testresult.append(["[.] Setze VDSO_05:VDSO_Vx3d auf (0 to +/-5 km/h)", ""])
    testresult.append(func_gs.setVelocity_kmph(0))
    testresult.append(["[.] Setze SiShift_StLghtDrvPosn auf  8 (P)", ""])
    testresult.append(func_gs.changeDrivePosition('P'))
    testresult.append(["[.] Setze  OBD_04__MM_PropulsionSystemActive auf  0 (NotActive)", ""])
