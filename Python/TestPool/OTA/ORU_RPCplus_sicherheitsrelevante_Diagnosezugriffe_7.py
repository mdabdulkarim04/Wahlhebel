# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_7.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 7
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_7!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_352")
    ...
    # test step 5
    testresult.append(["[.] Wait 5100ms to fill buffer", ""])
    time.sleep(5.10)
