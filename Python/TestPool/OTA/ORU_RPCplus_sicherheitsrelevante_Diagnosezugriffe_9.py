# *****************************************************************************
# -*- coding: latin1 -*-
# File    : ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_9.py
# Title   : OTA ORU_RPCplus sicherheitsrelevante Diagnosezugriffe 9
# Task    : A minimal "ORU_RPCplus_sicherheitsrelevante_Diagnosezugriffe_9!" test script
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_355")
    ...
    testresult.append(["[+] ECU einschalten: KL30 und KL15 aus", ""])
    #testenv.startupECU()
    hil.cl30_on__.set(1)
    hil.cl15_on__.set(0)
    ...
    # test step 1
    testresult.append(["[.] Setze OTAMC_D_01.Setze VehicleProtectedEnvironment_D = 0 (VPE_none) ", ""])
    ...
    # test step 6
    testresult.append(["[.] Setze Signale OTAMC_D und VDSO_05 Signale:", ""])
    ...
    # test step 8
    testresult.append(["[.] Clamp_15 auf an", ""])
    hil.cl15_on__.set(1)
    hil.ClampControl_01__KST_KL_15__value.set(1)

    # test step 9
    testresult.append(["[.] Setze OTAMC_D_01 auf 1 (VPE_production)", ""])
    ...
    testresult.extend(canape_diag.changeAndCheckDiagSession('programming', ticket_id='FehlerId:EGA-PRM-215'))

    # test step 12
    testresult.append(["[.] Auslesen der Active Diagnostic Session: 0x22F186", ""])
    testresult.extend(canape_diag.checkDiagSession('programming', ticket_id='FehlerId:EGA-PRM-215'))
