...
# -*- coding: latin-1 -*-
#
# File    : ORUnext_BZ_Fehler.py
# Title   : ORUnext_BZ_Fehler
# Task    : ORUnext in BZ Fehler
#           
# Author  : M.A. Mushtaq
# Date    : 23.02.2022
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_300")
    ...
    # test step 2
    testresult.append(["[.] Setze Kein BZ Error in ORU_Control_D_01 ", ""])
    ...
    # test step 8
    testresult.append(["[.] Setze BZ error ORU_Control_D_01 ", ""])
    ...
    # test step 10-10.5
    testresult.append(["[.] Setze ungulitige Precondition", ""])
