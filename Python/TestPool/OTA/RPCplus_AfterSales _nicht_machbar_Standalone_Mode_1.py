...
# -*- coding: latin-1 -*-
#
# File    : RPCplus_AfterSales_nicht_machbar_Standalone_Mode_1.py
# Title   : RPCplus_AfterSales_nicht_machbar_Standalone_Mode_1
# Task    : RPCplus AfterSales nicht machbar in Standalone Mode 1
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_390")
