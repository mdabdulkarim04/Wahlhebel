...
# -*- coding: latin-1 -*-
#
# File    : ORUnext_Flashing_CRC_Fehler.py
# Title   : ORUnext_Flashing_CRC_Fehler
# Task    : ORUnext in CRC Fehler
#           
# Author  : M.A. Mushtaq
# Date    : 23.02.2022
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_299")
    ...
    # test step 2
    testresult.append(["[.] Setze Kein ORU_Control CRC Error", ""])
    ...
    # test step 8
    testresult.append(["[.] Setze CRC Error ORU_Control_D_01 ", ""])
