...
try:
    ...
    if response[0:3] == [98, 2, 203]:
        ...
        if BusKnockoutTmr_start is not None:
            if BusKnockoutTmr_start > 64:
                ...
                testresult.append([
                                      "\xa0 Gespeichere Wert für BusKnockoutTmr_start (Variable) für späteren Vergleich ist %s" % BusKnockoutTmr_start])
        else:
    ...
    if BusKnockoutTmr_start is not None:
        testresult += [
            basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, BusKnockoutTmr_start,
                                    descr=" KPrüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer == bus_tmr == 15 (Ausgangswert; Timer läuft nicht)")]
    ...
    # test step 8
    testresult.append(["\x0a 8.  Prüfe veto würde erkannt"])
    ...
    # test step 10
    testresult.append(["\x0a 10. Wechsel in die Entwicklersession, (in Factory mode security access dürchführen) "
                       "Setze mittels 2E 09 F3: KnockOut_Test_mode  auf 0x4 * (Supress Veto == Active), "
                       "um BUSKnockOut testen zu können und warte 2sec"])
    ...
    # test step 11
    testresult.append(["\x0a 11. Prüfe kein veto würde erkannt."])
    ...
    # test step 15
    testresult.append(["\x0a 15. Prüfe, dass Reset des SG stattfindet"])
    ...
    # test step 18
    testresult.append(["\x0a 18 Prüfe nichtflüchtige Speicherung von BusKnockOut_Tmr"])
    request = [0x22] + diag_ident_KN_TMR['identifier']
    response, result = canape_diag.sendDiagRequest(request)
    testresult.append(result)
    BusKnockoutTmr = None
    ...
    # test step 21
    testresult.append(["\x0a 21.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    if BusKnockoutTmr_start is not None:
        testresult += [
            basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, BusKnockoutTmr_start,
    ...
    if response[0:3] == [98, 2, 203]:
        ...
        if BusKnockoutTmr_2 is not None:
            if BusKnockoutTmr_2 > 64:
                ...
                testresult.append(["\xa0 Gespeichere Wert für BusKnockoutTmr_2 (Variable) für späteren Vergleich ist %s" % BusKnockoutTmr_2])
        else:
            BusKnockoutTmr_2 = 0
    ...
    # test step 24
    testresult.append(["\x0a 24.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    ...
    # test step 26.1
    testresult.append(["\x0a 26.1 Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    if BusKnockoutTmr_2 is not None:
        testresult += [
            basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, BusKnockoutTmr_2,
                                    descr=" KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer == bus_tmr_2 == 16 (Ausgangswert; Timer läuft nicht)")]
    else:
        testresult.append(["bus_tmr_2 kann nicht auslesen ", "FAILED"])

    # test step 26.2
    testresult.append(["\x0a 26.2 Prüfe BusKnockOut_Ctr"])
    request = [0x22] + diag_ident_KN_CTR['identifier']
    response, result = canape_diag.sendDiagRequest(request)
    testresult.append(result)
    testresult.append(["Auf positive Response überprüfen", ""])
    ...
    # test step 29
    testresult.append(["\x0a 29.  Prüfe veto würde erkannt"])
    testresult.append(basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 1,
                                              descr="KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 1 (Veto Aktiv)"))

    # test step 30
    testresult.append(
        ["\x0a 30. Prüfe 70 s lang, dass KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer eingefroren ist", ""])
    timerlist = []
    ...
    # test step 31
    testresult.append(["\x0a 31. Wechsel in die Entwicklersession, (in Factory mode security access dürchführen) "
                       "Setze mittels 2E 09 F3: KnockOut_Test_mode  auf 0x4 * (Supress Veto == Active), "
                       "um BUSKnockOut testen zu können und warte 2sec"])
    ...
    # test step 32
    testresult.append(["\x0a 32 Prüfe kein veto würde erkannt."])
    testresult.append(basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 0,
                                              descr="KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 0 (Initwert)"))

    # test step 33
    testresult.append(["\x0a 33 Prüfe KN_Waehlhebel:KN_Waehlhebel_BUSKnockOutTimer nach 60 Sekunden"])
    time.sleep(60)
    ...
    # test step 35
    testresult.append(["\x0a 35.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    ...
    # test step 36
    testresult.append(["\x0a 36. Prüfe, dass nach 60 sekund Kein Reset des SG stattfindet "])
    time.sleep(60)
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 0,
                                           descr="KN_Waehlhebel_BUSKnockOutTimer = 0")]

    # test step 37
    testresult.append(["\x0a 37. Prüfe KN_Waehlhebel:Waehlhebel_Abschaltstufe", ""])
    ...
    # test step 38
    testresult.append(["\x0a 38. Prüfe NVEM_12:NVEM_Abschaltstufe", ""])
    ...
    # test step 40
    testresult.append(["\x0a 40. Prüfe KN_Waehlhebel:Waehlhebel_Abschaltstufe", ""])
    ...
    # test step 41
    testresult.append(["\x0a 41.  Prüfe, dass Reset des SG stattfindet"])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 2,
                                           descr=" KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 2 (0x2= Funktion_ausgeloest)")]
    ...
    # test step 43
    testresult.append(["\x0a 43. Warte 1 min. und Prüfe Busruhe", ""])
    time.sleep(60)
    descr, verdict = func_gs.checkBusruhe(daq)
    testresult.append([descr, verdict])
    ...
    # test step 45
    testresult.append(["\x0a 45 Prüfe nichtflüchtige Speicherung von BusKnockOut_Tmr"])
    request = [0x22] + diag_ident_KN_TMR['identifier']
    response, result = canape_diag.sendDiagRequest(request)
    testresult.append(result)
    BusKnockoutTmr = None
    ...
    # test step 46
    testresult.append(["\x0a 46. Prüfe nichtflüchtige Speicherung von BusKnockOut_ctr"])
    request = [0x22] + diag_ident_KN_CTR['identifier']
    response_diag, result = canape_diag.sendDiagRequest(request)
    testresult.append(result)
    ...
    # test step 47
    testresult.append(["\x0a 47. Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOut"])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 2,
                                           descr=" KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 2 (0x2= Funktion_ausgeloest)")]

    # test step 48
    testresult.append(["\x0a 48. Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, 16,
