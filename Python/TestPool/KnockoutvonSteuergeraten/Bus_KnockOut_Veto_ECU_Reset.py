...
try:
    ...
    # test step 9
    testresult.append(["\x0a 9.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, 17,
                                           descr="KN_Waehlhebel_BUSKnockOutTimer = 17")]
    ...
    # test step 14
    testresult.append(["\x0a 14. Prüfe, dass KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer nach 1 Minute um 1 dekrementiert wird "])
    time.sleep(60)
    ...
    # test step 19
    testresult.append(["\x0a 19.Prüfe 70 s lang, dass KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer eingefroren ist", ""])
    timerlist = []
    ...
    # tests step 25
    testresult.append(["\x0a 25. Prüfe, dass nach 60 sekund Kein Reset des SG stattfindet "])
    time.sleep(60)
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 0,
                                           descr="KN_Waehlhebel_BUSKnockOut = 0")]

    # test step 26
    testresult.append(["\x0a 26. Prüfe KN_Waehlhebel:Waehlhebel_Abschaltstufe", ""])
    ...
    # test step 27
    testresult.append(["\x0a 27. Prüfe NVEM_12:NVEM_Abschaltstufe", ""])
    ...
    # test step 29
    testresult.append(["\x0a 29. Prüfe KN_Waehlhebel:Waehlhebel_Abschaltstufe", ""])
    ...
    # test step 30
    testresult.append(["\x0a 30.  Prüfe, dass Reset des SG stattfindet"])
    ...
    # test step 33
    testresult.append(["\x0a 33 Prüfe BusKnockOut_Tmr"])
    request = [0x22] + diag_ident_KN_TMR['identifier']
    response, result = canape_diag.sendDiagRequest(request)
    testresult.append(result)
    testresult.append(["Auf positive Response überprüfen", ""])
    ...
    # test step 34
    testresult.append(["\x0a 34 Prüfe BusKnockOut_ctr"])
    request = [0x22] + diag_ident_KN_CTR['identifier']
    ...
    # test step 37
    testresult.append(["\x0a 37. Wechsel in die Entwicklersession, (in Factory mode security access dürchführen)"
                       "Setze mittels 2E 09 F3: KnockOut_Test_mode  auf 0x2 * (Veto == Active), "])
    ...
    # tests tep 38
    testresult.append(["\x0a 38.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, 17,
                                           descr="KN_Waehlhebel_BUSKnockOutTimer = 17")]
    # test step 39
    testresult.append(["\x0a 39 Prüfe 70 s lang, dass KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer nicht läuft", ""])
    timerlist = []
    KN_Waehlhebel_BusKnockOutTimer = 17
    sec = 70
    timeout = sec + t()
    ...
    # test step 40
    testresult.append(["\x0a 40. Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOut"])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 2,
                                           descr=" KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 2 (0x2= Funktion_ausgelöst)")]

    # test step 41
    testresult.append(["\x0a 41. Wechsel in die Entwicklersession, (in Factory mode security access dürchführen) "
    ...
    # test step 42
    testresult.append(["\x0a 42.Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer "])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOutTimer__value, 17,
                                           descr="KN_Waehlhebel_BUSKnockOutTimer = 17")]

    # test step 43
    testresult.append(["\x0a 43. Prüfe 70 s lang, dass KN_Waehlhebel:KN_Waehlhebel_BusKnockOutTimer  nicht läuft", ""])
    timerlist = []
    ...
    # test step 44
    testresult.append(["\x0a 44. Prüfe KN_Waehlhebel:KN_Waehlhebel_BusKnockOut"])
    testresult += [basic_tests.checkStatus(hil.KN_Waehlhebel__KN_Waehlhebel_BusKnockOut__value, 2,
                                           descr=" KN_Waehlhebel:KN_Waehlhebel_BusKnockOut = 2 (0x2= Funktion_ausgelöst)")]
