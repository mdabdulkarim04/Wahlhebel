#******************************************************************************
# -*- coding: latin1 -*-
# File    : Sichere_Erkennung _SiShift_Fehler_D.py
# Title   : Sichere Erkennung Sishift Fehler D
# Task    : Sichere Erkennung der Sishift Fehler D
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_138")
    ...
    while hil.Waehlhebel_04__WH_SensorPos_roh__value.get() == 4 or t_out > t():
        if hil.Waehlhebel_04__WH_SensorPos_roh__value.get() == 6:
            ...
            testresult.append(basic_tests.checkStatus(current_status=wh_fahrstufe, nominal_status=5,
                                                      descr="Prüfe, dass WH_Fahrstufe = 5 ist"))
            break
        elif not (t_out > t()):
