# *****************************************************************************
# -*- coding: latin1 -*-
# File    :Diagnose_VW_ECU_Hardware_Version_Number.py
# Title   :Diagnose VW ECU Hardware Version Number
# Task    : Test for Diag ECU Hardware Version number
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_253")
