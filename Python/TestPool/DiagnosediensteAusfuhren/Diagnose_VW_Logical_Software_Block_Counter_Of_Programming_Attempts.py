# *****************************************************************************
# -*- coding: latin1 -*-
# File    : Diagnose_VW_Logical_Software_Block_Counter_Of_Programming_Attempts.py
# Title   : Diagnose VW Logical Software Block Counter Of Programming Attempts
# Task    : Test for Diag identifier 0407
#
...
# 1.1  | 08.10.2021 | Mohammed     | Rework
# 1.2  | 12.10.2021 | Mohammed     | Added TestSpec ID
# 1.3  | 22.12.2021 | H. Förtsch   | reworked test script by test spec
# *****************************************************************************
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_254")
