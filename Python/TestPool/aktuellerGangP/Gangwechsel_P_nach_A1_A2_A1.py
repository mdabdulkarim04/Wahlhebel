#******************************************************************************
# -*- coding: latin1 -*-
# File    : Gangwechsel_P_nach_A1_A2_A1.py
# Title   : Gangwechsel P nach A1 A2 A1
# Task    : Gangwechsel aus P nach A2 über A1 (hin und zurück)
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_42")
