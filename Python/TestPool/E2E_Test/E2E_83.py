...
# -*- coding: latin1 -*-
# File    : E2E_83.py
# Title   : ORU_Control_D_CRC_Error_ReStart_MonCycle_3Times
...
# 1.1  | 16.08.2022 | Devangbhai   | Added 2.5 sec insted 1.5sec in step 1.1, 6.1, 12.1 and 18.1
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_83")
    ...
    # test step 2
    testresult.append(["[-] Sende einmal CRC-Error für ORU_Control_D_01 und warte 220ms.", ""])
    sec = 0.160
    timeout = sec + t()
    while timeout > t():
