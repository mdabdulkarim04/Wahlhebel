...
# -*- coding: latin1 -*-
# File    : E2E_34.py
# Title   : OTAMC_DD_CRC_Error_SSP_No_Healing
# Task    : Wiederholte Fehlererkennung OTAMC_D und Wechsel nach "Safe State Permanent". Heilung in diesem Zustand ist nicht möglich.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_34")
