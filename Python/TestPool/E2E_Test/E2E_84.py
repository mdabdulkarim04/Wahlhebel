...
# -*- coding: latin1 -*-
# File    : E2E_84.py
# Title   : OTAMC_D_CRC_Error_ReStart_MonCycle_3Times
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_84")
    ...
    # test step 2
    testresult.append(["[-] Sende einmal CRC-Error für OTAMC_D_01 und warte 220ms.", ""])
    sec = 0.160
    timeout = sec + t()
    while timeout > t():
        OTAMC_timestamp = hil.OTAMC_D_01__timestamp.get()
        hil.OTAMC_D_01__OTAMC_D_01_CRC__value.set(0)
        new_timestamp = hil.OTAMC_D_01__timestamp.get()
