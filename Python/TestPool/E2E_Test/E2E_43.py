...
# -*- coding: latin1 -*-
# File    : E2E_43.py
# Title   : SiShift_CRC_Error_SSP_Init
# Task    : Wiederholte Fehlererkennung SiShift_01_CRC und Wechsel nach "Safe State Permanent" aus "Initialized" über "Normal".
#
...
# 1.1  | 19.08.2022 | Devangbhai   | Added correct precondition, Added 80ms in test step 4 insted of 40ms
...
def checkProgrammingPrecondition(exp_content):
    ...
    """
    # test step
    testresult.append(["\x0a Programmiervorbedingungen prüfen: 0x3101 + {}"
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_43")
    ...
    # test step 2.1
    testresult.append(["[+] Warte 50ms (Wechsel nach Initialized, Der initiale Timeout beträgt 500ms )", ""])
    time.sleep(0.050)
    ...
    # test step 4
    testresult.append(["[.] Setze SiShift_01 zyklus zeit auf 20ms und warte 80ms. (Wechsel nach Normal State, zwei gültige Botschaften(2*20ms= 40ms) im FIFO)", ""])
