...
# -*- coding: latin1 -*-
# File    : E2E_48.py
# Title   : ORU_Control_A_CRC_Error_SSP_Normal
# Task    : Wiederholte Fehlererkennung ORU_Control_A_01_CRC und Wechsel nach "Safe State Permanent" aus dem Zustand "Normal".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_48")
    ...
    # test step 3
    testresult.append(["[.] Sende zweimal CRC-Error für ORU_Control_A_01_CRC. (Wechsel nach  Safe State)", ""])
    sec = 0.800
    send= 0
    timeout = sec + t()
    while timeout > t():
