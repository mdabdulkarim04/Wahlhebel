...
# -*- coding: latin1 -*-
# File    : E2E_95.py
# Title   : OTAMC_D_BZ_Error_Timeout_Qualification
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_95")
    ...
    # test step 2
    testresult.append(["[-] Sende 2 OTAMC_D_BZ failure und 7  OTAMC_D_BZ Timeout error. (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 13 fehlende Botschaft im FIFO )", ""])
