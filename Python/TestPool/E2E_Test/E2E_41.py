...
# -*- coding: latin1 -*-
# File    : E2E_41.py
# Title   : ORU_Control_D_CRC_Error_Repeat
# Task    : Mehrmalige Fehlererkennung ORU_Control_D_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_41")
