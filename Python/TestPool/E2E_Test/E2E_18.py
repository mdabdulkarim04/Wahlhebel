...
# -*- coding: latin1 -*-
# File    : E2E_18.py
# Title   :OTAMC_D_BZ_Error_not_qualified
# Task    : Keine Fehlererkennung OTAMC_D_01_BZ während "Initialized" aufgrund noch nicht verstrichener Timeout-Qualifizierungsdauer.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_18")
    ...
    # test step 3
    testresult.append(["[-] Setze OTAMC_D_01 zyklus zeit auf 320ms und sende einmal OTAMC_D_01_BZ Fehler", ""])
    ...
    testresult.append(canape_diag.checkEventMemoryEmpty(ticket_id="EGA_PRM_264"))
