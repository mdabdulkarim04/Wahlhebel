...
# -*- coding: latin1 -*-
# File    : E2E_63.py
# Title   : OTAMC_D_Timeout_Diag_Suppressed_not_qulified
# Task    : Keine erstmalige Timeout-Fehlererkennung OTAMC_D_01 während "Initialized" aufgrund noch nicht verstrichener Timeout-Qualifizierungsdauer bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_63")
