...
# -*- coding: latin1 -*-
# File    : E2E_94.py
# Title   : ORU_Control_A_BZ_Error_Timeout_Qualification
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_94")
    ...
    # test step 2
    testresult.append(["[-] Sende 2 ORU_Control_A_BZ failure und 7  ORU_Control_A_BZ Timeout error. (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 13 fehlende Botschaft im FIFO )", ""])
    hil.ORU_Control_A_01__ORU_Control_A_01_BZ__switch.set(1)
    time.sleep(1.5)
    hil.ORU_Control_A_01__period.set(0)
    time.sleep(3.500+ 0.200)
