...
# -*- coding: latin1 -*-
# File    : E2E_49.py
# Title   : ORU_Control_D_CRC_Error_SSP_Normal
# Task    : Wiederholte Fehlererkennung ORU_Control_D_01_CRC und Wechsel nach "Safe State Permanent" aus dem Zustand "Normal".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_49")
    ...
    # test step 2
    testresult.append(["[-] Prüfe Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    checkProgrammingPrecondition(exp_content=[])

    # test step 3
    testresult.append(["[.] Sende zweimal CRC-Error für ORU_Control_D_01_CRC. (Wechsel nach  Safe State)", ""])
    sec = 0.635
    timeout = sec + t()
