...
# -*- coding: latin1 -*-
# File    : E2E_103.py
# Title   : ORU_Control_D_BZ_Error_Timeout_Qualification2
...
# 1.1  | 12.08.2022 | Devangbhai   |  Change the timing in test step 1.1 from 1.5sec to 2.5 sec
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_103")
    ...
    # test step 2
    testresult.append(["[-] Sende 2 ORU_Control_D_BZ failure und 1 ORU_Control_D_BZ timeout error.", ""])
    ...
    # test step 4
    testresult.append(["[.]  Sende 3 ORU_Control_D_BZ failure", ""])
    hil.ORU_Control_D_01__period.set(320)
    time.sleep(0.960 + 0.100)
