...
# -*- coding: latin1 -*-
# File    : E2E_86.py
# Title   : ORU_Control_D_NoError_Normal
...
# 1.1  | 16.08.2022 | Devangbhai   | Added 2.5 sec insted 1.5sec in step 1.1. Change set cycle time in step 2 to 970ms
# 1.2  | 19.08.2022 | Devangbhai   | Added correct Precondition
# 1.3  | 24.08.2022 | Devangbhai   | Changed the test step according to new test specification
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_86")
    ...
    testresult.append(["[-] Sende ORU_Control_D_01 BZ > ORU_Control_D_01 Timeout failure unterlab Toleranzschwelle und "
                       "prufe Fehlerspeicher und dann sende ORU_Control_D_01 BZ < ORU_Control_D_01 Timeout failure "
                       "unterlab Toleranzschwelle und prufe fehlerspeicher", ""])
    for i in range(1, 11):
        ...
        testresult.append(["\xa0 Lese Fehlerspeicher aus nach Schleife %s" % i, ""])
    ...
    # # test step 2
    # testresult.append(["[-] Setze ORU_Control_D_01 zyklus zeit auf 970ms. (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 10-2+1= 9 fehlende Botschaft im FIFO  )", ""])
    # hil.ORU_Control_D_01__period.set(970)
    #
    # # test step 3
    # testresult.append(["[.] Warte 2910msec (3 Zyklus Zeit mit neue Zyklus Zeit)", ""])
    # time.sleep(2.910)
    #
    # # test step 4
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    ...
    #
    # # test step 6
    # testresult.append(["[.] Setze ORU_Control_D_01 zyklus zeit auf 320ms und warte 1600ms+ 200ms Toleranze (n/2 gültige signal im FIFO)",""])
    # hil.ORU_Control_D_01__period.set(320)
    # time.sleep(1.600 + 0.200)
    #
    # # test step 7
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    # checkProgrammingPrecondition(exp_content=[])
    ...
    #
    # # test step 9
    # testresult.append(["[.] Warte 2240ms (Qualifikation Zeit für BZ Failure DTC eintrag = n-q+ 1= 9 fehlende Botschaft im FIFO )", ""])
    # time.sleep(2.240)
    #
    # # test step 10
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    ...
    #
    # # test step 12
    # testresult.append(["[.] Setze  ORU_Control_D_01_BZ  wider fort und warte 1600ms+ 200ms Toleranze (n/2 gültige signal im FIFO)", ""])
    # hil.ORU_Control_D_01__ORU_Control_D_01_BZ__switch.set(0)
    # time.sleep(1.600 + 0.200)
    #
    # # test step 13
