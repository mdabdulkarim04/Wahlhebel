...
# -*- coding: latin1 -*-
# File    : E2E_33.py
# Title   : ORU_Control_D_CRC_Error_SSP_No_Healing
# Task    : Wiederholte Fehlererkennung ORU_Control_D und Wechsel nach "Safe State Permanent". Heilung in diesem Zustand ist nicht möglich.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_33")
    ...
    # test step 8
    testresult.append(["[.] Warte 1500ms", ""])
    time.sleep(1.500)
