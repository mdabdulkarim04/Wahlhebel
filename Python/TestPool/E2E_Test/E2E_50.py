...
# -*- coding: latin1 -*-
# File    : E2E_50.py
# Title   : OTAMC_D_CRC_Error_SSP_Normal
# Task    : Wiederholte Fehlererkennung OTAMC_D_01_CRC und Wechsel nach "Safe State Permanent" aus dem Zustand "Normal".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_50")
    ...
    # test step 3
    testresult.append(["[.] Sende zweimal CRC-Error für OTAMC_D_01_CRC. (Wechsel nach  Safe State)", ""])
    sec = 0.635
    timeout = sec + t()
    while timeout > t():
