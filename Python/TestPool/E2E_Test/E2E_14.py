...
# -*- coding: latin1 -*-
# File    : E2E_14.py
# Title   :OTAMC_D_CRC_Error_First
# Task    : Erstmalige Fehlererkennung OTAMC_D_01_CRC während "Initialized" erfolgt Wechsel in den Zustand "Safe State" innerhalb FR, wobei Flashvorgang via Überprüfung der Programmiervorbedingungen abgelehnt wird.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_14")
    ...
    # test step 1 and 2
    testresult.append(["[.] Setze OTAMC_D_01 zyklus zeit auf 0, Schalte Kl30 ein.", ""])
    ...
    # test step 3
    testresult.append(["[-] Setze OTAMC_D_01 zyklus zeit auf 320ms und sende OTAMC_D_01_CRC Fehler in erste Botschaft (Wechsel nach Safe State)", ""])
    sec = 0.315
    timeout = sec + t()
