...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_87")
    ...
    # # test step 2
    # testresult.append(["[-] Setze OTAMC_D_01 zyklus zeit auf 970ms. (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 10-2+1= 9 fehlende Botschaft im FIFO  )", ""])
    # hil.OTAMC_D_01__period.set(970)
    #
    # # test step 3
    # testresult.append(["[.] Warte 2.910sec (3 Zyklus Zeit mit neue Zyklus Zeit)", ""])
    # time.sleep(2.910)
    #
    # # test step 4
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    ...
    #
    # # test step 6
    # testresult.append(["[.] Setze OTAMC_D_01 zyklus zeit auf 320ms und warte 1600ms+ 200ms Toleranze (n/2 gültige signal im FIFO)",""])
    ...
    #
    # # test step 8
    # testresult.append(["[.] Halte OTAMC_D_01_BZ.", ""])
    ...
    #
    # # test step 12
    # testresult.append(["[.] Setze  OTAMC_D_01_BZ  wider fort und warte 1600ms+ 200ms Toleranze (n/2 gültige signal im FIFO)", ""])
    ...
    testresult.append(["[-] Sende OTAMC_D_01 BZ > OTAMC_D_01 Timeout failure unterlab Toleranzschwelle und "
                       "prufe Fehlerspeicher und dann sende OTAMC_D_01 BZ < OTAMC_D_01 Timeout failure "
