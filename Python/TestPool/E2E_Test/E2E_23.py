...
# -*- coding: latin1 -*-
# File    : E2E_23.py
# Title   : SiShift_CRC_Error_First_And_Return
# Task    : Einmalige Fehlererkennung SiShift_01_CRC und Wechsel aus "Safe State" in den Zustand "Normal" nach Empfang von n/2 gültiger S-PDUs.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_23")
    ...
    # test step 2
    testresult.append(["[.] Warte 550ms  (Weil  2 mal alle 2 E2E im FIFO sein müssen).", ""])
    time.sleep(0.550)
