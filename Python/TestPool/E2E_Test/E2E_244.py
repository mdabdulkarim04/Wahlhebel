...
# -*- coding: latin1 -*-
# File    : E2E_244.py
# Title   : CRC_Error_Single
# Task    : Einzelne CRC-Fehler, die bei unterschiedlichen Signalen auftreten, werden erkannt, dürfen aber nicht zu einem SafeStatePermanent führen und werden nach Empfang von n/2 gültiger S-PDUs wieder zurückgenommen, in dem vom Safe State in den Normal State gewechselt wird.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_244")
    ...
    # test step 2
    testresult.append(["[-] Sende einmal CRC-Error für OTAMC_D_01_CRC. (Wechsel nach  Safe State)", ""])
    sec = 0.200
    timeout = sec + t()
    while timeout > t():
    ...
    # test step 8
    testresult.append(["[.] Warte t = n/2 = 14/2*20 ms =140 ms + 20ms Toleranze", ""])
    ...
    # test step 11
    testresult.append(["[.] Warte t=1520 ms(1600ms - 160ms -20ms +(100ms) Toleranz) (n/2 = 10/2 = 5*320= 1600).", ""])
    time.sleep(1.520)
