...
# -*- coding: latin1 -*-
# File    : E2E_102.py
# Title   : OTAMC_D_BZ_Error_Timeout_Qualification2
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_102")
    ...
    # test step 2
    testresult.append(["[-] Sende 2 OTAMC_D_BZ failure und 1 OTAMC_D_BZ timeout error.", ""])
    ...
    # test step 4
    testresult.append(["[.]  Sende 3 OTAMC_D_BZ failure", ""])
    hil.OTAMC_D_01__period.set(320)
