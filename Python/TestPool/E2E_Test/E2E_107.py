...
# -*- coding: latin1 -*-
# File    : E2E_107.py
# Title   : ORU_Control_D_CRC_Error_Diag_Suppressed_Repeat
# Task    : Mehrmalige Fehlererkennung ORU_Control_D_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent" bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_107")
