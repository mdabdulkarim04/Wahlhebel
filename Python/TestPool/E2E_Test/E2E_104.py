...
# -*- coding: latin1 -*-
# File    : E2E_104.py
# Title   : ORU_Control_A_BZ_Error_Timeout_Qualification2
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_104")
    ...
    # test step 2
    testresult.append(["[-] Sende 2 ORU_Control_A_BZ failure und 1 ORU_Control_A_BZ timeout error.", ""])
    ...
    # test step 4
    testresult.append(["[.]  Sende 3 ORU_Control_A_BZ failure", ""])
    hil.ORU_Control_A_01__period.set(500)
    time.sleep(1.500 + 0.200)
