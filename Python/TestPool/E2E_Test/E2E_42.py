...
# -*- coding: latin1 -*-
# File    : E2E_42.py
# Title   : OTAMC_D_CRC_Error_Repeat
# Task    : Mehrmalige Fehlererkennung OTAMC_D_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_42")
