...
# -*- coding: latin1 -*-
# File    : E2E_61.py
# Title   : ORU_Control_A_Timeout_Diag_Suppressed_not_qulified
# Task    : Keine erstmalige Timeout-Fehlererkennung ORU_Control_A_01 während "Initialized" aufgrund noch nicht verstrichener Timeout-Qualifizierungsdauer bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_61")
