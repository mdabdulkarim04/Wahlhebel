...
# -*- coding: latin1 -*-
# File    : E2E_24.py
# Title   : ORU_Control_A_CRC_Error_First_And_Return
# Task    : Einmalige Fehlererkennung ORU_Control_A_01_CRC und Wechsel aus "Safe State" in den Zustand "Normal" nach Empfang von n/2 gültiger S-PDUs.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_24")
    ...
    # test step 5
    testresult.append(["[-] Warte 2500ms +100ms Tolerenze (n/2 = 10/2 = 5*500= 2500).", ""])
    time.sleep(2.500 + 0.100)
