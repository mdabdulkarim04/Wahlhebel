...
# -*- coding: latin1 -*-
# File    : E2E_47.py
# Title   : OTAMC_D_CRC_Error_SSP_Init
# Task    : Wiederholte Fehlererkennung OTAMC_D und Wechsel nach "Safe State Permanent" aus "Initialized" über "Normal".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_47")
    ...
    # test step 6
    testresult.append(["[.] Sende Zweite CRC-Error für OTAMC_D_01_CRC. (Wechsel nach  Safe State permanant)", ""])
    sec = 0.315
    timeout = sec + t()
    while timeout > t():
        hil.OTAMC_D_01__OTAMC_D_01_CRC__value.set(0)
