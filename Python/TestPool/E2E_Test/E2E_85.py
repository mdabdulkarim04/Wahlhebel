...
# -*- coding: latin1 -*-
# File    : E2E_85.py
# Title   : ORU_Control_A_NoError_Normal
...
# 1.1  | 16.08.2022 | Devangbhai   | Added 2.5 sec insted 1.5sec in step 1.1. Change set cycle time in step 2 to 1510ms insted of 3500ms
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_85")
    ...
    testresult.append(["[-] Sende ORU_Control_A_01 BZ > ORU_Control_A_01 Timeout failure unterlab Toleranzschwelle und "
                       "prufe Fehlerspeicher und dann sende ORU_Control_A_01 BZ < ORU_Control_A_01 Timeout failure "
    ...
    # # test step 2
    # testresult.append(["[-] Setze ORU_Control_A_01 zyklus zeit auf 1510ms. (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 10-2+1= 9 fehlende Botschaft im FIFO  )", ""])
    # hil.ORU_Control_A_01__period.set(1510)
    #
    # # test step 3
    # testresult.append(["[.] Warte 4.530 sec (3 Zyklus Zeit mit neue Zyklus Zeit)", ""])
    # time.sleep(4.530)
    #
    # # test step 4
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    ...
    #
    # # test step 6
    # testresult.append(["[.] Setze ORU_Control_A_01 zyklus zeit auf 500ms und warte 2500ms+ 200ms Toleranze (n/2 gültige signal im FIFO)",""])
    # hil.ORU_Control_A_01__period.set(500)
    ...
    #
    # # test step 9
    # testresult.append(["[.] Warte 3500ms (Qualifikation Zeit für BZ Failure DTC eintrag = n-q+ 1= 9 fehlende Botschaft im FIFO )", ""])
    # time.sleep(3.500)
    #
    # # test step 10
    # testresult.append(["[.] Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    ...
    #
    # # test step 12
    # testresult.append(["[.] Setze  ORU_Control_A_01_BZ  wider fort und warte 2500ms+ 200ms Toleranze (n/2 gültige signal im FIFO)", ""])
    # hil.ORU_Control_A_01__ORU_Control_A_01_BZ__switch.set(0)
    # time.sleep(2.500 + 0.200)
    #
    # # test step 13
