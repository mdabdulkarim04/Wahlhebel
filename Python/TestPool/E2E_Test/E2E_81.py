...
# -*- coding: latin1 -*-
# File    : E2E_81.py
# Title   : OTAMC_D_CRC_Error_ReStart_MonCycle
...
# 1.1  | 16.08.2022 | Devangbhai   | Added 2.5 sec insted 1.5sec in step 1.1
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_81")
    ...
    while timeout > t():
        ...
        if OTAMC_timestamp != new_timestamp:
