...
# -*- coding: latin1 -*-
# File    : E2E_32.py
# Title   : ORU_Control_A_CRC_Error_SSP_No_Healing
# Task    : Wiederholte Fehlererkennung ORU_Control_A und Wechsel nach "Safe State Permanent". Heilung in diesem Zustand ist nicht möglich.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_32")
