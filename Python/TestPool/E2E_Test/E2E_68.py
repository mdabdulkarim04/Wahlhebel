...
# -*- coding: latin1 -*-
# File    : E2E_68.py
# Title   : ORU_Control_D_Timeout_Diag_Suppressed
# Task    : Erstmalige Timeout-Fehlererkennung ORU_Control_D_01 während "Initialized" bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_68")
