...
# -*- coding: latin1 -*-
# File    : E2E_26.py
# Title   : OTAMC_D_CRC_Error_First_And_Return
# Task    : Einmalige Fehlererkennung OTAMC_D_01_CRC und Wechsel aus "Safe State" in den Zustand "Normal" nach Empfang von n/2 gültiger S-PDUs.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_26")
