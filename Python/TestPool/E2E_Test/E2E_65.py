...
# -*- coding: latin1 -*-
# File    : E2E_65.py
# Title   : ORU_Control_A_Timeout_Diag_Suppressed
# Task    : Erstmalige Timeout-Fehlererkennung ORU_Control_A_01 während "Initialized" bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_65")
    ...
    # test step 2.1
    testresult.append(["[+]  warte 1500ms +  100ms Toleranz (Wechsel nach Initialized, Der initiale Timeout beträgt 1500ms )", ""])
