...
# -*- coding: latin1 -*-
# File    : E2E_100.py
# Title   : SiShift_BZ_Error_Normal
# Task    :Erstmalige Fehlererkennung SiShift_01_BZ während "Normal"
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_100")
    ...
    # test step 1
    testresult.append(["[.] Schaltle Kl30 und Kl15 und RBS ein und warte 2.5 s", ""])
    hil.cl15_on__.set(1)
    ...
    # test step 2
    testresult.append(["[.] Sende permament SiShift_01_BZ Fehler (Wechsel nach Safe State)", ""])
    hil.SiShift_01__SiShift_01_20ms_BZ__switch.set(1)

    # test step 3
    testresult.append(["[.] Warte 260 ms (n-q+1 Botschaften in FIFO= 14-2+1 = 13*20 = 260ms ).", ""])
    time.sleep(0.260 + 0.025)
