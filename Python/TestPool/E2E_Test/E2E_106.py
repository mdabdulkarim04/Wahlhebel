...
# -*- coding: latin1 -*-
# File    : E2E_106.py
# Title   : ORU_Control_A_CRC_Error_Diag_Suppressed_Repeat
# Task    : Mehrmalige Fehlererkennung ORU_Control_A_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent" bei Diagnoseausblendung.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_106")
    ...
    # test step 3
    testresult.append(["[.]  Warte nur 1500ms. ( t = n/2 = 10/2 = 5*500 ms = 2500 ms = Zeit bis zum Wechsel in den Normalzustand, wenn kein 2. CRC Fehler erkannt wird).",""])
    time.sleep(1.500)
