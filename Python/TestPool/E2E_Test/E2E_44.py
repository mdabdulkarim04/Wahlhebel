...
# -*- coding: latin1 -*-
# File    : E2E_44.py
# Title   : SiShift_CRC_Error_SSP_Normal
# Task    : Wiederholte Fehlererkennung SiShift_01_CRC und Wechsel nach "Safe State Permanent" aus dem Zustand "Normal".
#
...
# 1.1  | 19.08.2022 | Devangbhai   | Added correct precondition, added 2500ms insted of 1500ms in test step 1.1
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_44")
    ...
    # test step 1
    testresult.append(["[.]  Schalte Kl30, Kl15 ein und RBS an und warte bis erste NM Botschaft empfängt. ", ""])
    hil.cl15_on__.set(1)
    ...
    # test step 1.1
    testresult.append(["[+] warte 2500ms.(Wechsel nach Normal aus Initialized,  (Weil  2 mal alle 2 E2E im FIFO sein müssen)", ""])
    time.sleep(2.500)

    # test step 2
    testresult.append(["[-] Prüfe WH_Fahrstufe und Programming-Precondition (0x31 0x01 0x02 0x03) prüfen. ", ""])
    testresult.append(
        basic_tests.checkStatus(
            current_status=hil.Waehlhebel_04__WH_Fahrstufe__value.get(),
            nominal_status=15,
    ...
    # test step 5
    testresult.append(["[.] Lese Botschaft Waehlhebel_04::WH_Fahrstufe", ""])
    testresult.append(basic_tests.checkStatus(current_status=hil.Waehlhebel_04__WH_Fahrstufe__value.get(), nominal_status=15, equal=True, descr="Prüfe WH_Fahrstufe = 15 ist"))
