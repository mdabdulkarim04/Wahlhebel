...
# -*- coding: latin1 -*-
# File    : E2E_40.py
# Title   : ORU_Control_A_CRC_Error_Repeat
# Task    : Mehrmalige Fehlererkennung ORU_Control_A_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_40")
