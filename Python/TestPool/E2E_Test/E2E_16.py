...
# -*- coding: latin1 -*-
# File    : E2E_16.py
# Title   :ORU_Control_A_BZ_Error_not_qualified
# Task    : Keine Fehlererkennung ORU_Control_A_01_BZ während "Initialized" aufgrund noch nicht verstrichener Timeout-Qualifizierungsdauer.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_16")
    ...
    # test step 3
    testresult.append(["[-] Setze ORU_Control_A_01 zyklus zeit auf 500ms und sende einmal ORU_Control_A_01_BZ Fehler", ""])
