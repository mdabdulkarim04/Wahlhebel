...
# -*- coding: latin1 -*-
# File    : E2E_101.py
# Title   : ORU_Control_A_BZ_Error_Normal
# Task    :Erstmalige Fehlererkennung ORU_Control_A_01_BZ während "Normal"
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_101")
    ...
    # test step 1
    testresult.append(["[.] Schaltle Kl30 und Kl15 und RBS ein und warte 2 s", ""])
    hil.cl15_on__.set(1)
    ...
    # test step 2
    testresult.append(["[.] Sende permament ORU_Control_A_01_BZ Fehler (Wechsel nach Safe State)", ""])
