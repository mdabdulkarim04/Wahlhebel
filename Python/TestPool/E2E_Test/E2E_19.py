...
# -*- coding: latin1 -*-
# File    : E2E_19.py
# Title   : SiShift_Timeout_not_qualified
# Task    : Keine erstmalige Timeout-Fehlererkennung SiShift_01 während "Initialized" aufgrund noch nicht verstrichener Timeout-Qualifizierungsdauer.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_19")
    ...
    # test step 1 and 2
    testresult.append(["[.] Setze SiShift timer auf 0Schalte kl30 ein", ""])
