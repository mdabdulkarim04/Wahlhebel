...
# -*- coding: latin1 -*-
# File    : E2E_52.py
# Title   : SiShift_Timeout_Diag_Suppressed
# Task    : Erstmalige Timeout-Fehlererkennung SiShift_01 während "Initialized" bei Diagnoseausblendung..
#
...
# ------------------------------------------------------------------------------
# 1.0  | 21.07.2022 | Devangbhai   | initial
# 1.1  | 18.08.2022 | Devangbhai   | Added Ticket number, Added correct Precondition
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_52")
    ...
    # test step 2.1
    testresult.append(["[+] warte 500ms + 50ms Toleranz (Wechsel nach Initialized, Der initiale Timeout beträgt 500ms )", ""])
    time.sleep(0.550)
    ...
    testresult.append(_checkStatus(
            ...
            nominal_status=15,
            equal=True,
            descr="Prüfe WH_Fahrstufe = 15 ist", ticket_id="EGA_PRM_282"))
