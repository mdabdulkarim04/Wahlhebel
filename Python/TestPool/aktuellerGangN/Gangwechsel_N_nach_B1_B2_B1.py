#******************************************************************************
# -*- coding: latin1 -*-
# File    : Gangwechsel_N_nach_B1_B2_B1.py
# Title   : Gangwechsel N nach B1 B2 B1
# Task    : Gangwechsel aus N nach B2 über B1 (hin und zurück)
#
...
# 1.2  | 02.03.2022 | Devangbhai patel | Added the missing test step
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_59")
