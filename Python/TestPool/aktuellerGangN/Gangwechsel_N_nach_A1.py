#******************************************************************************
# -*- coding: latin1 -*-
# File    : Gangwechsel_N_nach_A1.py
# Title   : Gangwechsel N nach A1
# Task    : Gangwechsel aus N nach A1
#
...
# 1.1  | 16.09.2021 | Devangbhai patel | Rework
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_54")
...
### 1
    ...
    # Implementation for checking the WH Fahrstufe value by bringing the WH from X to position A1
    timeout = 60
    t_out = timeout + t()
