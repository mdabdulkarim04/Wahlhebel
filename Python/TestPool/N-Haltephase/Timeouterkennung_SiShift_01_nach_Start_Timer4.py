...
#------------------------------------------------------------------------------
# 1.0  | 23.07.2021 | M. Abdul Karim | initial
# 1.1  | 30.07.2021 | M. Abdul Karim | Rework
#******************************************************************************
#
# Imports #####################################################################
...
try:
    ...
    descr, verdict = func_nm.waitTillTimerEnds(timer=3, switch_rx_signals=True)
    testresult.append([descr, verdict])

    testresult.append(["[.] Setze Zykluszeit der Botschaft SiShift_01 auf 0ms", ""])
    hil.SiShift_01__period.setState('an')
    time.sleep(0)
    descr, verdict = func_gs.switchAllRXMessagesOn()
    testresult.append([descr, verdict])

    testresult.append([" Warte 4950ms (tMSG_CYCLE)", ""])
    time.sleep(4.95)
    testresult.append(["[.] Lese Fehlerspeicher aus (0x200101 -DTC aktiv)", ""]) ###
