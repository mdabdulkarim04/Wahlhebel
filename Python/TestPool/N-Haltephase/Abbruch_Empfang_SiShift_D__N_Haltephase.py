...
# -*- coding: latin-1 -*-
#
# File    : Abbruch_Empfang_SiShift_D__N_Haltephase.py
# Title   : N-Haltephase Abbruch Empfang SiShift = D
# Task    : Test Abbruch der N-Haltephase nach Abbruch Empfang SiShift = D
#
# Author  : A. Neumann
# Date    : 17.05.2021
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_121")
    ...
    time.sleep(60)
    descr, verdict = func_gs.changeDrivePosition('D', True)
    testresult.append(["\xa0"+descr, verdict])
