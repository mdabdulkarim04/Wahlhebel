...
try:
    ...
    testresult.append(["\xa0Prüfe Waehlhebel_04:WH_Zustand_N_Haltephase_2", "INFO"])
    testresult.append(
        basic_tests.checkStatus(
            current_status=hil.Waehlhebel_04__WH_Zustand_N_Haltephase_2__value,
            nominal_status=1,
    ...
    testresult.append(["\xa0Prüfe nach %s Minute Busruhe und Strommonitoring" % (time_sleep / 60), ""])
    testresult.append(
        basic_tests.checkRange(
            value=hil.cc_mon__A.get(),
            min_value=0.002,  # 2mA
    ...
    testresult.append(["[.] Prüfe nach 1 Minute Busruhe und Strommonitoring", ""])
    time.sleep(1)
    descr, verdict = func_gs.checkBusruhe(daq, 1)
    testresult.append([descr, verdict])
    ...
    testresult.append(["\xa0Prüfe Busruhe und Strommonitoring", ""])
    testresult.append(
        basic_tests.checkRange(
            value=hil.cc_mon__A.get(),
            min_value=0.002,  # 2mA
    ...
    testresult.append(["[.] Prüfe, dass nach einer Minute Busruhe ist", ""])
    time.sleep(60)
