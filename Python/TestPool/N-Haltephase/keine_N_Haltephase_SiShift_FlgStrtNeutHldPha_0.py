...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_FlgStrtNeutHldPha_0.py
# Title   : keine N Haltephase SiShift = 0
# Task    : N Haltephase wird nicht gestartet (SiShift_FlgStrtNeutHldPha = 0)
#
...
# 1.2  | 07.02.2022 | Mohammed   | Added Strommonitoring
# 1.3  | 27.04.2022 | Mohammed   | Added NM_Waehlhebel_FCAB = 1, 12, 41
# 1.4  | 28.07.2022 | Mohammed   | Rework
# ******************************************************************************
#
# Imports #####################################################################
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_174")
    ...
    testresult.append(
        ["\xa0 Prüfe NM_Waehlhebel_FCAB:mindestens --> 01_CarWakeUp, 12_GearSelector und 41_Diagnosis_Powertrain", ""])
    ...
    testresult.append(["[.] Setze SiShift FlgStrtNeutHldPha auf 0 (StartNeutralHoldPhase)", ""])
    ...
    testresult.append(
        _checkStatus(
            current_status=hil.Waehlhebel_04__WH_Zustand_N_Haltephase_2__value,
            nominal_status=0,
            descr="Prüfe, dass Wert 0 (Init) ist", ticket_id='FehlerId:EGA-PRM-17',
        )
    )
    ...
    testresult.append(["\xa0 Prüfe NM_Waehlhebel:NM_Waehlhebel_CBV_AWB auf 0", ""])
    testresult.append(
        basic_tests.checkStatus(
