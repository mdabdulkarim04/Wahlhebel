...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_StLghtDrvPosn_R.py
# Title   : keine_N_Haltephase_SiShift_StLghtDrvPosn = R
...
# 1.1  | 26.07.2021 | Mohammed | Added Fehler ID
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_177")
