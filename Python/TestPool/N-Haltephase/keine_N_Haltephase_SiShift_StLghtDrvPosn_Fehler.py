...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_StLghtDrvPosn_Fehler.py
# Title   : keine N Haltephase SiShift = 15
# Task    : N Haltephase wird nicht gestartet (SiShift_StLghtDrvPosn = 15)
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_175")
    ...
    testresult.append(["[+] Waehlhebelposition Fehler aktiviert", ""])
