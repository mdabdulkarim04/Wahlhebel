...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_StLghtDrvPosn_D_nach_Init.py
# Title   : keine N Haltephase SiShift = D
...
# 1.2  | 04.02.2022 | Mohammed   | Added Fehler ID
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_136")
