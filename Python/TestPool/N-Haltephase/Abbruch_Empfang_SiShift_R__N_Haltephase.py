...
# -*- coding: latin-1 -*-
#
# File    : Abbruch_Empfang_SiShift_R__N_Haltephase.py
# Title   : N-Haltephase Abbruch Empfang SiShift = R
# Task    : Test Abbruch der N-Haltephase nach Abbruch Empfang SiShift = R
#
# Author  : A. Neumann
# Date    : 17.05.2021
...
# 1.2  | 13.07.2021 | Mohammed   | SIShift_StLghtDrvPosn senden, nach 150 ms
#******************************************************************************
#
# Imports #####################################################################
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_120")
    ...
    testresult.append(["[-] Prüfe Strommonitorung und Busruhe nach 1 Minute", ""])
    time.sleep(60)
    testresult.append(
    ...
    time.sleep(60)
    descr, verdict = func_gs.changeDrivePosition('R', True)
    testresult.append(["\xa0"+descr, verdict])
    ### ## add Tolarence
    time.sleep(0.500)  # 2*Zykluszeit
