...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_StLghtDrvPosn_P_nach_Init.py
# Title   : keine N Haltephase SiShift = P nach Init
# Task    : N Haltephase wird nicht gestartet (SiShift_StLghtDrvPosn = 8)
#
# Author  : A. Neumann
# Date    : 18.05.2021
...
# 1.4  | 14.03.2022 | Mohammed   | Added NM-Botschaft not sending
# 1.5  | 27.04.2022 | Mohammed   | Added NM_Waehlhebel_FCAB = 1, 12, 41
# 1.6  | 27.07.2022 | Mohammed   | Rework
#******************************************************************************
#
# Imports #####################################################################
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_112")
    ...
    # ##########################################################
    testresult.append(["[.] Warte 150ms und CAN-Trace auswerten", ""])
    time.sleep(0.15)
