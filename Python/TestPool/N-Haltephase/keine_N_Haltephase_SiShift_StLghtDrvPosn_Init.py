...
# -*- coding: latin-1 -*-
#
# File    : keine_N_Haltephase_SiShift_StLghtDrvPosn_Init.py
# Title   : keine N Haltephase SiShift = Init
# Task    : N Haltephase wird nicht gestartet (SiShift_StLghtDrvPosn = 0)
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_172")
    ...
    testresult.append(["[+] Waehlhebelposition Init aktiviert", ""])
