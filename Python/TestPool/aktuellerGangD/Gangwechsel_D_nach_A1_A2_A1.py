#******************************************************************************
# -*- coding: latin1 -*-
# File    : Gangwechsel_D_nach_A1_A2_A1.py
# Title   : Gangwechsel D nach A1 A2 A1
# Task    : Gangwechsel aus D nach A2 über A1 (hin und zurück)
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_66")
