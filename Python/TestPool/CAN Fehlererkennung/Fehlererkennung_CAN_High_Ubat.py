...
# -*- coding: latin-1 -*-
#
# File    : Fehlererkennung_CAN_High_Ubat.py
# Task    : Eindrahtfehler und Fehlererkennung am CAN High (Kurzschluss Can Low gegen Plus)
...
#------------------------------------------------------------------------------
# 1.0  | 01.07.2021  | A. Neumann | initial
# 1.1  | 19.11.2021  | Mohammed | Rework
#******************************************************************************
...
try:
    ...
    exp_dtc = 1111 # Todo
    failure_set_time = 1.0
    failure_reset_time = 0.500
    can_location = 'HIGH'
    failure_type = 'SHORT_TO_UBAT'
