...
# -*- coding: latin-1 -*-
#
# File    : testresult_examples.py
# Title   : testresult_examples
...
try:
    ...
    # set Testcase ID #########################################################
    setTestcaseId(testresult, 'Swc_GSL_IOHardwareAbstraction_HallSensor2_Value')
    ...
    testresult.append(testTxSigSeq(
        set_var=cal.Swc_GSL_IOHardwareAbstraction_HallSensor2_Value,  # TODO: Add correct cal-variable from .a2l
        check_sig=hil.DEV_Waehlhebel_Req_00__DEV_Waehlhebel_Req_00_Data__value,
