...
# 1.7  | 18.05.2022 | Mohammed | Added ac_case variable
# ******************************************************************************
# TTk 2.0
...
class HilVars(GammaVarContainer):
    def __init__(self, gamma_api):
        ...
        self.ORU_Control_A_01__ORU_Control_A_01_BZ__value = GammaVarDeferred(gamma_api,
                                                                             ...
                                                                             unit="")  # default="0.0"
        self.ORU_Control_A_01__ORU_Control_A_01_BZ__switch = GammaVarDeferred(gamma_api,
                                                                             "Waehlhebel:CAN.can0_HIL.HIL_TX.ORU_Control_A_01.signals.ORU_Control_A_01_BZ.ac_case",
                                                                             unit="")  # default="0.0"
        ...
        self.ORU_Control_A_01__ORU_Control_A_01_CRC__value = GammaVarDeferred(gamma_api,
                                                                              ...
                                                                              unit="")  # default="0.0"
        self.ORU_Control_A_01__ORU_Control_A_01_CRC__switch = GammaVarDeferred(gamma_api,
                                                                              "Waehlhebel:CAN.can0_HIL.HIL_TX.ORU_Control_A_01.signals.ORU_Control_A_01_CRC.ac_case",
                                                                              unit="")  # default="0.0"
        ...
        self.ORU_Control_D_01__ORU_Control_D_01_BZ__value = GammaVarDeferred(gamma_api,
                                                                             ...
                                                                             unit="")  # default="0"
        self.ORU_Control_D_01__ORU_Control_D_01_BZ__switch = GammaVarDeferred(gamma_api,
                                                                             "Waehlhebel:CAN.can0_HIL.HIL_TX.ORU_Control_D_01.signals.ORU_Control_D_01_BZ.ac_case",
                                                                             unit="")  #
        self.ORU_Control_D_01__ORU_Control_D_01_CRC__value = GammaVarDeferred(gamma_api,
                                                                              ...
                                                                              unit="")  #
        self.ORU_Control_D_01__ORU_Control_D_01_CRC__switch = GammaVarDeferred(gamma_api,
                                                                              "Waehlhebel:CAN.can0_HIL.HIL_TX.ORU_Control_D_01.signals.ORU_Control_D_01_CRC.ac_case",
                                                                              unit="")  #
        ...
        self.OTAMC_D_01__OTAMC_D_01_CRC__value = GammaVarDeferred(gamma_api,
                                                                  ...
                                                                  unit="")  # default="0"
        self.OTAMC_D_01__OTAMC_D_01_CRC__switch = GammaVarDeferred(gamma_api,
                                                                  "Waehlhebel:CAN.can0_HIL.HIL_TX.OTAMC_D_01.signals.OTAMC_D_01_CRC.ac_case",
                                                                  unit="")  # default="0"
        ...
        self.OTAMC_D_01__OTAMC_D_01_BZ__value = GammaVarDeferred(gamma_api,
                                                                 ...
                                                                 unit="")  # default="0"
        self.OTAMC_D_01__OTAMC_D_01_BZ__switch = GammaVarDeferred(gamma_api,
                                                                 "Waehlhebel:CAN.can0_HIL.HIL_TX.OTAMC_D_01.signals.OTAMC_D_01_BZ.ac_case",
                                                                 unit="")  # default="0"
        ...
        self.ORU_01__period = GammaVarDeferred(gamma_api, "Waehlhebel:CAN.can0_HIL.HIL_TX.ORU_01.period", lookup={0: "aus", 500: "an"}) # added the period
        ...
        self.SiShift_01__SiShift_01_20ms_BZ__value = GammaVarDeferred(gamma_api,
                                                                      ...
                                                                      unit="")  # default="0"
        self.SiShift_01__SiShift_01_20ms_BZ__switch = GammaVarDeferred(gamma_api,
                                                                       "Waehlhebel:CAN.can0_HIL.HIL_TX.SiShift_01.signals.SiShift_01_20ms_BZ.ac_case",
                                                                       unit="")  # default="0"
        self.SiShift_01__SiShift_01_20ms_CRC__value = GammaVarDeferred(gamma_api,
                                                                       ...
                                                                       unit="")  # default="0"
        self.SiShift_01__SiShift_01_20ms_CRC__switch = GammaVarDeferred(gamma_api,
                                                                       "Waehlhebel:CAN.can0_HIL.HIL_TX.SiShift_01.signals.SiShift_01_20ms_CRC.ac_case",
                                                                       unit="")  # default="0"
        ...
        self.VDSO_05__period = GammaVarDeferred(gamma_api, "Waehlhebel:CAN.can0_HIL.HIL_TX.VDSO_05.period", lookup={0: "aus", 5: "an"}) # KMatrix20210226 # changed from 5 to 20ms as defined in the gamma
        ...
        self.DPM_01__period = GammaVarDeferred(gamma_api, "Waehlhebel:CAN.can0_HIL.HIL_TX.DPM_01.period", lookup={0: "aus", 10: "an"}) # KMatrix20210226
        ...
        self.ClampControl_01__ClampControl_01_BZ__value = GammaVarDeferred(gamma_api,
                                                                           ...
                                                                           unit="")  # default="0"
        self.ClampControl_01__ClampControl_01_BZ__switch = GammaVarDeferred(gamma_api,
                                                                           "Waehlhebel:CAN.can0_HIL.HIL_TX.ClampControl_01.signals.ClampControl_01_BZ.ac_case",
                                                                           unit="")  # default="0"
        ...
        self.cc_mon__A = GammaVarDeferred(gamma_api,
                                               ...
                                               default=False,
                                               resettable=False)
        self.cv_mon__V = GammaVarDeferred(gamma_api,
                                               'Waehlhebel:UserInterface.IORead.PowerSupplyRead.cv_mon__V',
                                               unit="A",
                                               alias="CV Monitor V",
                                               descr="Voltage monitored volts",
                                               default=False,
                                               resettable=False)
        ...
        self.bus_physical_error = GammaVarDeferred(gamma_api,
                                                   ...
                                                   default=0,
                                                   resettable=True)
		# ******************** N1SRC_Measurement_Low (NonMux) ********************
                          # Gamma PVs for complete RX-message:
        self.N1SRC_Measurement_Low__length = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_RX.N1SRC_Measurement_Mid.length")
        self.N1SRC_Measurement_Low__payload = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_RX.N1SRC_Measurement_Mid.payload")
        self.N1SRC_Measurement_Low__timestamp = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_RX.N1SRC_Measurement_Mid.timestamp")
        self.N1SRC_Measurement_Low__CurrentLow__value = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_RX.N1SRC_Measurement_Mid.signals.CurrentMid.value", unit="mA") # default="0"
       # self.N1SRC_Measurement_Low__CurrentLow__value_phy = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_RX.N1SRC_Measurement_Mid.signals.CurrentMid.static_value_phy", unit="mA") # default="0"
       # ******************** N1SRC_SetMode (NonMux) ********************
                         # Gamma PVs for complete TX-message:        
        
        self.N1SRC_SetMode__length = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.length")
        self.N1SRC_SetMode__payload = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.payload")
        self.N1SRC_SetMode__min_delay = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.min_delay")
        self.N1SRC_SetMode__timestamp = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.timestamp")
        self.N1SRC_SetMode__period = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.period")
        self.N1SRC_SetMode__trigger = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.trigger")
        self.N1SRC_SetMode__counter = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.counter")
        self.N1SRC_SetMode__Mode__offset = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.signals.Mode.offset", unit="") # default="0"
        self.N1SRC_SetMode__Mode__static_value_phy = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.signals.Mode.static_value_phy", unit="") # default="0"
        self.N1SRC_SetMode__Mode__static_value_raw = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.signals.Mode.static_value_raw", unit="") # default="0"
        self.N1SRC_SetMode__Mode__value = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_SetMode.signals.Mode.value", unit="") # default="0"
        
                
        # ******************** N1SRC_ReqData (NonMux) ********************
        # Gamma PVs for complete TX-message:
        self.N1SRC_ReqData__length = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.length")
        self.N1SRC_ReqData__payload = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.payload")
        self.N1SRC_ReqData__min_delay = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.min_delay")
        self.N1SRC_ReqData__timestamp = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.timestamp")
        self.N1SRC_ReqData__period = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.period")
        self.N1SRC_ReqData__trigger = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.trigger")
        
        self.N1SRC_ReqData__CycleTime__value = GammaVarDeferred(gamma_api, "Waehlhebel:BusSystems.can3_iFIU_SRC_Cards.HIL_TX.N1SRC_ReqData.signals.CycleTime.value", unit="ms") # default="0"									
# #############################################################################
#
# #############################################################################
